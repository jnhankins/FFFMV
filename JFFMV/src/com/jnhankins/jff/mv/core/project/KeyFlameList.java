 ...
 * <p>
 * Using the {@link #getFlame(double, com.jnhankins.jff.flame.Flame) getFlame()} method it is
 ...
 * {@link Flame#lerp(com.jnhankins.jff.flame.Flame, com.jnhankins.jff.flame.Flame, float, com.jnhankins.jff.flame.Flame) interpolating}
...
public class KeyFlameList extends PropertyChangeAdapter implements Serializable {
    /**
     * Indicates that an new {@link Entry} was
     * {@link #add(com.jnhankins.jff.mv.core.project.ProjectFlame, double) added}.
     */
    public static final String ENTRY_ADDED_PROPERTY = "entryAdded";
    
    /**
     * Indicates that an {@link Entry} was
     * {@link #remove(KeyFlameList.Entry)  removed}.
     */
     ...
     * {@link #getFlame(double, com.jnhankins.jff.flame.Flame) getFlame()} when
     * the method's {@code currTime} argument increases monotonically on
     * successive invocations of the method.
     */
    private int index = -1;
